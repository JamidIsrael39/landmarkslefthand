...
def landmarks_csv(ruta, puntos):
    ...
    for nombres, valores in puntos.items(): #Se crea un ciclo for para escribir los puntos de las imágenes leídas
        nombre = nombres #Se escribe el nombre de la imagen
