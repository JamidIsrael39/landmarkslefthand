...
#################################################
    ...
    if comp_densidad(im_mirror,angulodominante,k_size):
        ...
        # print('hola')#israel agrego
    resta=435-angulodominante#israel agrego
        #valor ideal 435
    ...
    M = cv2.getRotationMatrix2D(center, resta+angulodominante, 1.0)#israel agrego
    rotated = cv2.warpAffine(rotated, M, (w, h))#israel agrego
